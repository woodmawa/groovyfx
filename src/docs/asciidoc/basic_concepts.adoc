...
card, groovyx.javafx.components.Card, "(args, body)"
cardHeader, javafx.scene.layout.VBox, "(args, body)"
cardBody, javafx.scene.layout.VBox, "(args, body)"
cardFooter, javafx.scene.layout.VBox, "(args, body)"
badge, groovyx.javafx.components.Badge, "(args)"
icon, groovyx.javafx.components.Icon, "(args)"
toggleSwitch, groovyx.javafx.components.ToggleSwitch, "(args)"
formLayout, groovyx.javafx.components.FormLayout, "(args, body)"
responsivePane, groovyx.javafx.components.ResponsivePane, "(args, body)"
colorPicker, javafx.scene.control.ColorPicker, "(args)"
pagination, javafx.scene.control.Pagination, "(args)"
